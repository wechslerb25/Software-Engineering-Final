...
public class LessThan extends AbstractOperator{
	...
	String operator = "" + CharConstants.LESS;

	/**
	 * Create a less than expression that takes as a parameter the given expressions
	 * 
	 * @param exp1 the left expression
	 * @param exp2 the right expression
	 */
	public LessThan(ExpressionTreeNode exp1, ExpressionTreeNode exp2) {
		super(exp1, exp2);
