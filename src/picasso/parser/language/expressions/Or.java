...
public class Or extends AbstractOperator{
	...
	String operator = "" + CharConstants.OR;

	/**
	 * Create an "or" expression that takes as a parameter the given expressions
	 * 
	 * @param exp1 the left expression
	 * @param exp2 the right expression
	 */
	public Or(ExpressionTreeNode exp1, ExpressionTreeNode exp2) {
		super(exp1, exp2);
	...
	public RGBColor evaluate(double x, double y) {
		...
		double out = Math.max(val1, val2);
		
		return new RGBColor(out,out,out);
	}
