...
/**
 * Represents the less than or equals to comparison.
 * @author Reese Nelson
 */
public class LessEquals extends AbstractOperator{
	
	String operator = "" + CharConstants.LESS + CharConstants.EQUAL;
	 ...
	 */
	public LessEquals(ExpressionTreeNode exp1, ExpressionTreeNode exp2) {
		super(exp1, exp2);
