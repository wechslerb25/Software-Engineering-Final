...
/**
 * Represents the greater than or equals to comparison.
 * @author Reese Nelson
 */
public class GreaterEquals extends AbstractOperator{
	
	String operator = "" + CharConstants.GREATER + CharConstants.EQUAL;

	/**
	 * Create a less than or greater to expression that takes as a parameter the given expressions
	 * 
	 * @param exp1 the left expression
	 * @param exp2 the right expression
	 */
	public GreaterEquals(ExpressionTreeNode exp1, ExpressionTreeNode exp2) {
		super(exp1, exp2);
